...
dataToProcess.drop(columns=['Address','Type','Method','SellerG','Date','Distance','Postcode','Car','BuildingArea','YearBuilt','CouncilArea','Lattitude','Longtitude','Regionname','Propertycount','Bedroom2'], inplace=True)
